...
## Chunk : penguins-1
```{r penguins-1, highlight.output=c(1,4:6)}
head(penguins)
```
---
...
.pull-right[
```{r first-plot1a-out, ref.label='first-plot1a', echo=FALSE,message=FALSE,warning=FALSE, out.width ="90%"}
```
]
---
.pull-left[
...
.pull-right[
```{r first-plot1b-out, ref.label='first-plot1b', echo=FALSE, message=FALSE,warning=FALSE, out.width="90%"}
```
]
---
.pull-left[
...
.pull-right[
```{r first-plot1c-out, ref.label='first-plot1c', echo=FALSE,message=FALSE,warning=FALSE, out.width="90%"}
```
]
...
.pull-right[
```{r first-plot1d-out, ref.label='first-plot1d', echo=FALSE,message=FALSE,warning=FALSE, out.width="90%"}
```
]
---
